...
AWS_ACCESS_KEY_ID = env('AWS_ACCESS_KEY_ID', default='SETME')
AWS_SECRET_ACCESS_KEY = env('AWS_SECRET_ACCESS_KEY', default='SETME')
AWS_STORAGE_BUCKET_NAME = env('DJANGO_STORAGE_BUCKET_NAME', default='SETME')
